		...
		egui::CentralPanel::default().show(ctx, |_ui| {
			match self.state {
				GameState::Setup => {
					...
					egui::Area::new("top_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [0.0, -30.0]).show(ctx, |ui|{
					...
					egui::Area::new("center_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [10.0, 0.0]).show(ctx, |ui|{
						ui.add(
							egui::Slider::new(&mut self.player_count, 3..=50)
						);
					});

					egui::Area::new("bottom_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [0.0, 30.0]).show(ctx, |ui|{
				...
				GameState::Rules => {
					...
					egui::Area::new("top_center_area").movable(false).anchor(egui::Align2::CENTER_TOP, [0.0, 80.0]).show(ctx, |ui|{
						ui.heading("Rules of Left Right Center");
					});

					egui::Area::new("center_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [35.0, 0.0]).show(ctx, |ui|{
						ui.label(format!("{}", self.rules));
					});
				},
				GameState::NameSetup => {
				...
				GameState::Play => {
					...
					egui::Area::new("center_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [0.0, 1.0]).show(ctx, |ui|{
						ui.vertical_centered(|ui| {
				...
				GameState::ShowDice => {
					egui::Area::new("top_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [0.0, -60.0]).show(ctx, |ui|{
					...
					egui::Area::new("bottom_area").movable(false).anchor(egui::Align2::CENTER_CENTER, [0.0, 60.0]).show(ctx, |ui|{
						if ui.button("Continue").clicked() {
							self.state = GameState::Play;
						}
					});
